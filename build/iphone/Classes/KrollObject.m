 ...
 * Copyright (c) 2009-2011 by mCMSQRReader, Inc. All Rights Reserved.
...
//@interface mCMSQRReaderObject : NSObject
//@end

@interface mCMSQRReaderObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[mCMSQRReaderObject class]])
		{
			for (NSString *key in [[(mCMSQRReaderObject*)o modules] allKeys])
			{
