...
// in simulator we redefine to format for mCMSQRReader Developer console
...
{\
	NSString * exceptionName = [@"org.mcmsqrreader." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mcmsqrreader";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UImCMSQRReaderNativeItemNone = -1, 
	UImCMSQRReaderNativeItemSpinner = -2,
	UImCMSQRReaderNativeItemProgressBar = -3,
	
	UImCMSQRReaderNativeItemSlider = -4,
	UImCMSQRReaderNativeItemSwitch = -5,
	UImCMSQRReaderNativeItemMultiButton = -6,
	UImCMSQRReaderNativeItemSegmented = -7,
	
	UImCMSQRReaderNativeItemTextView = -8,
	UImCMSQRReaderNativeItemTextField = -9,
	UImCMSQRReaderNativeItemSearchBar = -10,
	
	UImCMSQRReaderNativeItemPicker = -11,
	UImCMSQRReaderNativeItemDatePicker = -12,
	
	UImCMSQRReaderNativeItemInfoLight = -13,
	UImCMSQRReaderNativeItemInfoDark = -14,
	
	UImCMSQRReaderNativeItemDisclosure = -15,
	
	UImCMSQRReaderNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all mCMSQRReader instances of
