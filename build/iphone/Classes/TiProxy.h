...
//Rare exceptions to indicate a bug in the _mcmsqrreader code (Eg, function that a subclass should have implemented)
...
/**
 The base class for mCMSQRReader proxies.
 */
