...
@interface mCMSQRReaderObject : KrollCoverageObject {
#else
@interface mCMSQRReaderObject : KrollObject {
#endif
@private
...
extern NSString * mCMSQRReader$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	mCMSQRReaderObject *_mcmsqrreader;
    KrollObject* console;
	BOOL shutdown;
