...
/**
 Base class for all mCMSQRReader views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the mCMSQRReader view hierarchy (such as wrapped iOS UIViews) was touched.
