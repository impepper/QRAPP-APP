...
MAKE_SYSTEM_PROP(ACTIVITY,UImCMSQRReaderNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UImCMSQRReaderNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UImCMSQRReaderNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UImCMSQRReaderNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UImCMSQRReaderNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UImCMSQRReaderNativeItemContactAdd);
